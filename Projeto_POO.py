...
class Salario:
    ...
    def desconto_salario_1500_2500_solteiro(self):
        if (self.salario > 1500 and self.salario <= 2500 and self.estado_civil == 'S'):
            if (self.dependentes <= 1):
    ...
    def desconto_salario_2500_3500_solteiro(self):
        if (self.salario > 2500 and self.salario <= 3500 and self.estado_civil == 'S'):
            if (self.dependentes <= 1):
                return self.salario * 0.05
            elif (self.dependentes == 2 ):
                return self.salario * 0.03
    ...
    def desconto_salario_3500_4500_solteiro(self):
        if (self.salario > 3500 and self.salario <= 4500 and self.estado_civil == 'S'):
            if (self.dependentes <= 1):
    ...
    def desconto_salario_4500_solteiro(self):
        if (self.salario > 4500 and self.estado_civil == 'S'):
            if (self.dependentes <= 1):
...
#######################################################################################################################
    def desconto_salario_1500_casado(self):
        if (self.salario <= 1500 and self.estado_civil == 'C'):
            if (self.dependentes <= 1):
                return self.salario * 0.06
            elif (self.dependentes == 2 ):
                return self.salario * 0.05
    ...
    def desconto_salario_1500_2500_casado(self):
        if (self.salario > 1500 and self.salario <= 2500 and self.estado_civil == 'C'):
            if (self.dependentes <= 1):
                return self.salario * 0.05
            elif (self.dependentes == 2 ):
                return self.salario * 0.03
    ...
    def desconto_salario_2500_3500_casado(self):
        if (self.salario > 2500 and self.salario <= 3500 and self.estado_civil == 'C'):
            if (self.dependentes <= 1):
                return self.salario * 0.07
            elif (self.dependentes == 2 ):
                return self.salario * 0.05
    ...
    def desconto_salario_3500_4500_casado(self):
        if (self.salario > 3500 and self.salario <= 4500 and self.estado_civil == 'C'):
            if (self.dependentes <= 1):
                return self.salario * 0.08
            elif (self.dependentes == 2 ):
                return self.salario * 0.06
    ...
    def desconto_salario_4500_casado(self):
        if (self.salario > 4500 and self.estado_civil == 'C'):
            if (self.dependentes <= 1):
                return self.salario * 0.09
            elif (self.dependentes == 2 ):
                return self.salario * 0.08
    ...
    def desconto_salario_1500_viuvo(self):
        if (self.salario <= 1500 and self.estado_civil == 'V'):
            if (self.dependentes <= 1):
                return self.salario * 0.05
            elif (self.dependentes == 2 ):
                return self.salario * 0.04
    ...
    def desconto_salario_1500_2500_viuvo(self):
        if (self.salario > 1500 and self.salario <= 2500 and self.estado_civil == 'V'):
            if (self.dependentes <= 1):
                return self.salario * 0.04
            elif (self.dependentes == 2 ):
                return self.salario * 0.03
    ...
    def desconto_salario_2500_3500_viuvo(self):
        if (self.salario > 2500 and self.salario <= 3500 and self.estado_civil == 'V'):
            if (self.dependentes <= 1):
                return self.salario * 0.03
            elif (self.dependentes == 2 ):
                return self.salario * 0.02
    ...
    def desconto_salario_3500_4500_viuvo(self):
        if (self.salario > 3500 and self.salario <= 4500 and self.estado_civil == 'V'):
            if (self.dependentes <= 1):
                return self.salario * 0.02
            elif (self.dependentes == 2 ):
                return self.salario * 0.01
    ...
    def desconto_salario_4500_viuvo(self):
        if (self.salario > 4500 and self.estado_civil == 'V'):
            if (self.dependentes <= 1):
                return self.salario * 0.07
            elif (self.dependentes == 2 ):
                return self.salario * 0.06
    ...
    def desconto_salario_1500_divorciado(self):
        if (self.salario <= 1500 and self.estado_civil == 'D'):
            if (self.dependentes <= 1):
                return self.salario * 0.05
            elif (self.dependentes == 2 ):
                return self.salario * 0.04
    ...
    def desconto_salario_1500_2500_divorciado(self):
        if (self.salario > 1500 and self.salario <= 2500 and self.estado_civil == 'D'):
            if (self.dependentes <= 1):
                return self.salario * 0.04
            elif (self.dependentes == 2 ):
                return self.salario * 0.03
    ...
    def desconto_salario_2500_3500_divorciado(self):
        if (self.salario > 2500 and self.salario <= 3500 and self.estado_civil == 'D'):
            if (self.dependentes <= 1):
                return self.salario * 0.03
            elif (self.dependentes == 2):
                return self.salario * 0.02
    ...
    def desconto_salario_3500_4500_divorciado(self):
        if (self.salario > 3500 and self.salario <= 4500 and self.estado_civil == 'D'):
            if (self.dependentes <= 1):
                return self.salario * 0.02
            elif (self.dependentes == 2):
                return self.salario * 0.01
    ...
    def desconto_salario_4500_divorciado(self):
        if (self.salario > 4500 and self.estado_civil == 'D'):
            if (self.dependentes <= 1):
                return self.salario * 0.08
            elif (self.dependentes == 2):
                return self.salario * 0.07
